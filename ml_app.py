...
def run_ml_app():
    ...
    with st.expander("Prediction Result"):
        ...
        submenu = st.sidebar.selectbox("SubMenu", ["Logistic Regression", "Decision Tree","Random Forest"])
         
        if submenu == "Logistic Regression": 
            
            st.subheader("Logistic Regression Model")
            
            model = load_model("./models//log_regression_05_20_2023.pk1")
        ...
        elif submenu == "Random Forest": 
            
            st.subheader("Random Forest Model")
            
            model = load_model("./models//Random_Forest_05_20_2023.pk1")
            prediction = model.predict(single_sample)
            st.write(prediction)
            ...
            model = load_model("./models//Decision_Tree_05_28_2023.pk1")
            prediction = model.predict(single_sample)
            st.write(prediction)
